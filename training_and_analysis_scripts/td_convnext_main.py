...
def get_args_parser():
    ...
    parser.add_argument('--data_path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--val_split', default='val_12', type=str)
...
def main(args):
    ...
    if('td' in args.model):
        ...
        ##TDBLOCK
            ...
            apply_td_at_blocks_of_stages = args.apply_td_at_blocks_for_layers,
