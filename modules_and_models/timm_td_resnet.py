#Adapted from official code in https://github.com/rwightman/pytorch-image-models
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, cardinality=1, base_width=64, use_fca=False,
        ...
        self.se = create_attn(attn_layer, outplanes, use_fca=use_fca, fca_wh = c2wh[first_planes])
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, cardinality=1, base_width=64,
                 reduce_first=1, dilation=1, first_dilation=None, act_layer=nn.ReLU, norm_layer=nn.BatchNorm2d,
                 attn_layer=None, aa_layer=None, drop_block=None, drop_path=None, use_fca=False,
        ...
        #print(3, create_attn)
        #self.se = create_attn(attn_layer, outplanes, use_fca=use_fca)

        c2wh = dict([(64,56), (128,28), (256,14) ,(512,7)]) #Only used in cases wherein fca is used 
        #fca_wh
        
        self.se = create_attn(attn_layer, outplanes, use_fca=use_fca, fca_wh = c2wh[planes])
...
def make_blocks(
        ...
        down_kernel_size=1, avg_down=False, drop_block_rate=0., drop_path_rate=0.,  use_fca=False, 
    ...
    for stage_idx, (planes, num_blocks, db) in enumerate(zip(channels, block_repeats, drop_blocks(drop_block_rate))):
        ...
        for block_idx in range(num_blocks):
            ...
            if(stage_idx in apply_td_at_layers_list and block_idx in apply_td_at_blocks_for_layers[stage_idx]):
                is_td_block=True
            print(stage_idx, block_idx, is_td_block, apply_td_at_layers_list, apply_td_at_blocks_for_layers)
            ...
            if(is_td_block):
                ...
                inplanes, planes, stride, downsample, first_dilation=prev_dilation, use_fca=use_fca,
...
class TD_ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, in_chans=3,
                 ...
                 drop_block_rate=0., global_pool='avg', zero_init_last_bn=True, block_args=None, use_fca=False,
        ...
        stage_modules, stage_feature_info = make_blocks(
            ...
            drop_block_rate=drop_block_rate, drop_path_rate=drop_path_rate, use_fca= use_fca,
            #TD specific arguments
...
def _create_resnet(variant, pretrained=False, use_fca=False, **kwargs):
    print(kwargs)
